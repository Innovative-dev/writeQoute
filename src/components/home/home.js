...
class Home extends React.Component {
  ...
  likePost(postId,userId,photoURL,username){
    ...
    postLikes.set(body).then((res)=>{
      this.setState({likeActiveClass: true})
                        ...
                        <hr  className="my-2" />
                         <div className="d-flex justify-content-between">
                           <div>
                              ...
                              { item.likes ? this.test(item.likes,userId) : ''}
                              
                             <a className="font-15 mr-3"  
                                 style={this.state.likeActiveClass ? { color: 'red' } : { color: 'gray' }}
                                onClick = {()=> this.likePost(item.postId,userId,photoURL,username)}>
                               <FeatherIcon icon="heart" size="22" /></a>
                               
                             <a className="text-secondary font-15 mr-3" onClick={() => this.test()}>
                               <FeatherIcon icon="message-square" size="22" /></a>
                           </div>
                           <div>
                             {/* <a className="text-secondary font-15 mr-3"><FeatherIcon icon="dowload" size="22" /></a> */}
                         ...
                         <div className="d-flex">
                           ...
                           <button className="btn btn-sm " onClick = {this.openComments}>2 comments</button>
                                {/* {this.likesList(item.likes)} */}
                         </div>
                         <div className="comment-list" style={this.state.commentsList ? { 'display': 'block' } : { display: 'none' }}>
                         <div className="row m-0 mt-3 comment-box">
                            <div className="col-1 p-0 ">
                            <img className="header-avatar"  alt="img" src='https://wowsciencecamp.org/wp-content/uploads/2018/07/dummy-user-img-1.png' />
                            </div>
                            <div className="col-11 p-0">
                                <small><a className="font-weight-bold mr-2">Raghav</a>
                                  <span>it is ver nice a lorem  it is ver nice a lorem  it is ver nice a lorem  it is ver nice a lorem  </span>
                                </small>
                                <div className="d-flex">
                                <a className="text-secondary font-15 mr-1"><FeatherIcon icon="heart" size="18" /></a>
                                <small className="text-muted">12 Dec 2019, 12:12PM</small>
                                </div>
                            </div>
                         </div>
                         </div>
                         <div className="row m-0 mt-3 comment-box">
                            ...
                            <div className="col-11 p-0">
                                <input className="form-control rounded w-0" placeholder="type your comment"/>
                            </div>
                         </div>
